                        ...
                        if (task.isSuccessful()) {
                            ...
                            userRef.set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(user_SignIn.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(user_SignIn.this, user_login.class);
                                        startActivity(intent);
                                        finish(); // Close this activity
                                    } else {
                                        Toast.makeText(user_SignIn.this, "Failed to store user data", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        } else {
                            Toast.makeText(user_SignIn.this, "Registration Failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
